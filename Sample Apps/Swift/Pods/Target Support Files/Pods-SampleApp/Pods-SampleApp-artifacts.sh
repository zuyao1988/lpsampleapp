...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/LPMessagingSDK/LPMessagingSDK.xcframework" "" "true" "ios-x86_64-simulator/LPMessagingSDK.framework" "ios-arm64/LPMessagingSDK.framework"
fi
